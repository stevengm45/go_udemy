...
func leoArchivo2() {
	...
	if err != nil {
		...
		for scanner.Scan() { // este for lee cada una de las lineas del archivo
...
func graboArchivo() {
	...
	fmt.Fprintln(archivo, "Esta es una linea nueva") // este Fpintln es para grabar en un archivo
	archivo.Close()
